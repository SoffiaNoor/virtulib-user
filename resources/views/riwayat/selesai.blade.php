                        ...
                        <div class="card-body pt-2">
                            <div class="row">
                                <span class="mx-1 my-2 px-2 py-1 text-uppercase text-xs font-weight-bold"
                                    style="background:#587697;color:white!important;text-align:center">Finished Products</span>
                            </div>
                            <div class="row my-2">
                                <div class="col-sm-12">
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <span class="mx-1 my-2 px-2 py-1 text-uppercase font-weight-bold"
                                                style="color:#587697!important;text-align:center;font-size:2rem">Finished Products
                                            </span>
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <span class="ms-3 text-xs">
                                                        <form class="p-3" method="POST"
                                                            action="{{ route('move-products-selesai', $item->_id) }}"
