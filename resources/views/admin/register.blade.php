...
<body class="bg-[#8EACCD]" style="font-family: Poppins">
    ...
    <div class="h-screen md:flex justify-center">
        <div class="bg-[#F9F3CC] w-1/3 my-5 rounded-2xl shadow-xl">
            <form role="form mx-5" method="POST" action="{{ route('register') }}"
                class="w-full max-w-lg mx-auto">
                @csrf
                <h1 style="padding-top:1.5rem"
                    class="font-extrabold text-center pb-5  text-5xl bg-clip-text text-black">
                    Daftar Akun di VirtuLib
                </h1>
                @if (session('success'))
                ...
                <div class="flex flex-wrap mb-3">
                    <div class="w-full px-3">
                        ...
                        <div class="flex items-center">
                            ...
                            <label class="text-black">Seller</label>
                        </div>
                    </div>
                </div>
                <div class="text-center mx-3 items-center">
                    <button type="submit"
                        class="shadow bg-[#8EACCD] w-full my-2 mx-auto hover:bg-[#6d90b7] duration-500 hover:text-white focus:shadow-outline focus:outline-none text-black font-bold py-4 rounded-lg">
                        Register
                    </button>
                </div>
                <div class="mx-3 text-black">
                    Sudah punya akun? <a href="/login" class="text-blue-700 hover:text-blue-400"> Masuk disini</a>
                </div>
            </form>
        </div>
    </div>
        ...
        <div class="flex md:w-1/2 justify-center py-4 items-center">
            ...
            <form role="form mx-5" method="POST" action="{{ route('register') }}"
                ...
                <h1 style="padding-top:3rem"
                    class="font-extrabold text-transparent text-center pb-10  text-5xl bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600">
                    Daftar Akun di EduLink
                </h1>
                @if (session('success'))
                ...
                <div class="mx-3 text-white">
                    Sudah punya akun? <a href="/login" class="text-violet-300"> Masuk disini</a>
                </div>
            </form>
        </div>
    </div> --}}
