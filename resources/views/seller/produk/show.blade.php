                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="gender" name="gender" value="{{$products->name}}"
                                    readonly>
                            </div>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-sm-6 pt-2">
                            ...
                            <button class="btn btn-icon btn-3 btn-primary" type="button">
                                <a href="{{route('produk.edit', $products->name)}}"
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                Apakah anda yakin menghapus murid <span class="font-weight-bolder">{{$products->name}}</span>?
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Tidak</button>
                <form action="{{ route('produk.destroy', $products->name) }}" method="POST" style="display: inline;">
                    @csrf
                    @method('DELETE')
