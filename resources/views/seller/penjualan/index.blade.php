                            ...
                            <table class="table align-items-center mb-0">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-uppercase text-default text-xs font-weight-bolder">Product Name</th>
                                        <th class="text-uppercase text-default text-xs font-weight-bolder">Total Purchase</th>
                                        <th class="text-uppercase text-default text-xs font-weight-bolder ps-2">Price</th>
                                        <th class="text-uppercase text-default text-xs font-weight-bolder ps-2">Total Price</th>
                                        <th class="text-uppercase text-default text-xs font-weight-bolder ps-2">Delivery</th>
