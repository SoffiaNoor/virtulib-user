                ...
                <div class="flex flex-wrap -mx-4">
                        ...
                        <a href=""
                            ...
                            <div class="relative pb-48 overflow-hidden">
                                <img class="absolute inset-0 h-full w-full object-cover"
                                    src="{{ asset('assets/images/Buku1.png') }}"
                                    alt="">
                            </div>
                            <div class="p-4">
                                <span
                    ...
                    <div class="w-full sm:w-1/2 md:w-1/2 xl:w-1/4 p-4">
                        <a href="/detail"
                            ...
                            <div class="relative pb-48 overflow-hidden">
                                <img class="absolute inset-0 h-full w-full object-cover"
                                    src="{{ asset('assets/images/Buku2.png') }}"
                                    alt="">
                            </div>
                            <div class="p-4">
                                <span
                    ...
                    <div class="w-full sm:w-1/2 md:w-1/2 xl:w-1/4 p-4">
                        <a href=""
                            ...
                            <div class="relative pb-48 overflow-hidden">
                                <img class="absolute inset-0 h-full w-full object-cover"
                                    src="{{ asset('assets/images/Buku3.png') }}"/>
                            </div>
                            <div class="p-4">
                                <span
                                    class="inline-block px-2 py-1 leading-none bg-orange-200 text-orange-800 rounded-full font-semibold uppercase tracking-wide text-xs">Highlight</span>
                    ...
                    <div class="w-full sm:w-1/2 md:w-1/2 xl:w-1/4 p-4">
                        <a href=""
                            ...
                            <div class="relative pb-48 overflow-hidden">
                                <img class="absolute inset-0 h-full w-full object-cover"
                                    src="{{ asset('assets/images/Buku4.png') }}"
                                    alt="">
                            </div>
                            <div class="p-4">
                                <span
                    ...
                    <div class="w-full sm:w-1/2 md:w-1/2 xl:w-1/4 p-4">
                        <a href=""
                            ...
                            <div class="relative pb-48 overflow-hidden">
                                <img class="absolute inset-0 h-full w-full object-cover"
                                    src="{{ asset('assets/images/Buku5.png') }}"
                                    alt="">
                            </div>
                            <div class="p-4">
                                <span
                    ...
                    <div class="w-full sm:w-1/2 md:w-1/2 xl:w-1/4 p-4">
                        <a href=""
                            ...
                            <div class="relative pb-48 overflow-hidden">
                                <img class="absolute inset-0 h-full w-full object-cover"
                                    src="{{ asset('assets/images/Buku6.png') }}"
                                    alt="">
                            </div>
                            <div class="p-4">
                                <span
                    ...
                    <div class="w-full sm:w-1/2 md:w-1/2 xl:w-1/4 p-4">
                        <a href=""
                            ...
                            <div class="relative pb-48 overflow-hidden">
                                <img class="absolute inset-0 h-full w-full object-cover"
                                    src="{{ asset('assets/images/Buku7.png') }}"
                                    alt="">
                            </div>
                            <div class="p-4">
                                <span
                    ...
                    <div class="w-full sm:w-1/2 md:w-1/2 xl:w-1/4 p-4">
                        <a href=""
                            ...
                            <div class="relative pb-48 overflow-hidden">
                                <img class="absolute inset-0 h-full w-full object-cover"
                                    src="{{ asset('assets/images/Buku8.png') }}"
                                    alt="">
                            </div>
                            <div class="p-4">
                                <span
