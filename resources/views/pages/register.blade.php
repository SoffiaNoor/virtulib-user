...
<body class="bg-[#8EACCD]" style="font-family: Poppins">
    ...
    <div class="h-screen md:flex justify-center">
        <div class="bg-[#F9F3CC] w-1/3 my-5 rounded-2xl shadow-xl px-10 items-center self-center justify-center">
            <form role="form mx-5" method="POST" action="{{ route('register') }}" class="w-full max-w-lg mx-auto">
                @csrf
                ...
                <div class="text-center mx-3 items-center my-5">
                    <button type="submit"
